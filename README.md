...
6. Install packages with [Poetry](https://python-poetry.org/docs/): `poetry install --no-root`
7. Download the data (follow the link in your email) and unzip the containing data folders directly into your `/cshl-qb-course/` directory (`/cshl-qb-course/fe-data/`, `/cshl-qb-course/ephys-data/` etc.)
